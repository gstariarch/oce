...
**[oce-0.18](https://github.com/tpaviot/oce/releases/tag/OCE-0.18)** (December 2016)
...
| ------------- | ------------- |  ------------- |------------- |
| [0.18](https://github.com/tpaviot/oce/releases/tag/OCE-0.18)  | Yes | December 2016 | 6.9.1
...
Just ask @tpaviot (tpaviot@gmail.com) for a request regarding write access to
the repository.
